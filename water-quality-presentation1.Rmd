...
The "Sulfate" column had a lot of null values so if we kept it, our dataset would 
have a much more limited number of samples. After doing more research into the 
effects of increased levels of sulfates in drinking water, there are no long-term 
effects, only temporary laxative effects and some people can actually get used to 
higher sulfate concentrations in as soon as one week. This means that the level 
of sulfates in water would not have a great impact on our target variable, 
potability.
