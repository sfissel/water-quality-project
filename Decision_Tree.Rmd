...
pos_perf <- performance(pred,"tpr","fpr") # prediction for True Positive Rate and False Positive Rate 

plot(pos_perf, colorize=TRUE) # plot ROC curve

neg_perf <- performance(pred,"tnr","fnr") # prediction for True Negative Rate and False Negative Rate 

plot(neg_perf, colorize=TRUE) # plot ROC curve
```
