...
We renamed the categorical values (1 and 0) to "potable" and "non_potable"
...
### Splitting the data & Tuning & Test
```{r}
...
### Adjusting Threshold
We were adjusting threshold from 0.2 to 0.8, and found 0.6 is a good point considering the balance of sensitivity and specificity. However, the accuracy of the model is still low, so we need to improve on our model and reduce the False Negative values.
```{r}
